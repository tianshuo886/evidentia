...
CAPABILITIES = [
 ...
 {"id":"open_reading_base","area":"Core","claim":"Explicit project-independent Open Reading Base","schema":["paper_model"],"scripts":[],"tests":[],"status":"MISSING","evidence":"No open_reading_base schema or creation step; paper_model is used directly."},
 ...
 {"id":"lens_reconciliation","area":"Core","claim":"Agreement, complementary findings, conflicts and unresolved conflicts","schema":[],"scripts":["merge_lenses.py"],"tests":[],"status":"PARTIAL","evidence":"Deduplicated synthesis is generated, but semantic conflict detection is not implemented."},
 ...
 {"id":"provenance","area":"Core","claim":"Every important object traces to source and execution metadata","schema":[],"scripts":[],"tests":[],"status":"PARTIAL","evidence":"Some hashes and source links exist, but page/region/extractor/run/model/prompt metadata is not universal."},

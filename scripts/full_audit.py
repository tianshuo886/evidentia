...
def main():
 ...
 for script in ('contract_audit.py','validate_model.py','check_lenses.py','source_audit.py','verify_frozen.py','reader_audit.py'):
  results.append(call(script,'--out',str(r),*(['--write'] if script=='contract_audit.py' else [])))
